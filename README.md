...
This folder contains the course educational materials. **Labs** are the main entry point for students; each lab includes a goal, scenario, numbered steps, expected output, and a checklist.
...
```bash
python3 materials/generate_pdf_with_cover.py slides_deck/it/lecture_13_react-navigation-setup-and-route-params_it.md
```
...
- **Language**: Labs and primary slides in Italian; English slide decks for L00–L10 and L13–L21
